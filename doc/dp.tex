...
\\
  ...
  through various GENERIC constructs, up to the issues of employing
  in-line assembly, using GCC native preprocessor, or preparing the
  front end for cross compilation.  }
...
\\
  ...
  pøes rùzné konstrukce jazyka GENERIC, a¾ k problémùm se zapojením
  assembleru, pou¾ívání nativního preprocesoru, nebo pøípravì pøední
  èásti pro kroskompilaci.  }
...
compiler-related problems.  It's open development cycle makes up for
