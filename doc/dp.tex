...
cases, expressions, typechecking, name mangling and C-compatible
interfacing (extern "C"), (OpenMP?), and other to GENERIC (with the
help of proper hooks).  Show examples taken from \Algol 60 code.
