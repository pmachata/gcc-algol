...
@@@TODO -- dissolve ``Targeting GCC'' here in in Services chapter.
...
called GENERIC.  It is organized as a catalogue of typical constructs
found in programming language, and typical tasks performed by a
compiler, with explanation how to handle these in context of GCC.
...
\item GCC 4.2.x with resolved dependencies.  GCC 4.1.x or earlier will
  NOT work.  You will need either complete GCC package
...
\item Flex 2.5.31 or newer
\item Bison 2.3 or newer
\item \literal{libga60} wraps around target-native \literal{libc} and
  \literal{libm}, which have to be available on target site.
\end{itemize}

\section*{Supported Arches}

\file{gcc-algol} was successfully compiled and testsuite passed on
systems with following triplets:
