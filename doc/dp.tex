...
required library isn't at the commandline yet, in which situation you
will add it to the vector and adjust \variable{argc} accordingly.
It's necessary to support native \GCC switches, such as
\option{-nostdlib} and \option{-nodefaultlibs}, as well as your own
switches that imply that no linking is to be done
