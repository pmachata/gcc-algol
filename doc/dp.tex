...
\section{Design of Abstract Syntax Tree}

AST node layout mostly follows main grammar elements of \Algol 60.
Following sections delve into what's noteworthy across AST design.

\subsection{Expressions, Commands, etc.}
