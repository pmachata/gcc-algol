...
are GCC-2.9x slowly drifting towards irrelevance today.
...
hierarchy, used in other context, viz. as taget of the
...
expressions\footnote{It doesn't compute anything interesting, but uses
  all computed \literal{\keyw{goto}} features \Algol 60 has}:
...
handy.  It recursively dumps the tree passed in as argument, giving
you a chance to inspect whether the node in hand makes any sense.


\section{Variables, Types, Symbols}

A fundamental part of any programming language processing is dealing
with {\em symbols}, ways of typing and typechecking them, and handling
scoping rules.
