...
global, local (nested), overloaded, internal, external, anonymous
functions, visibility (static or public), pass by value, reference and
name, varargs, modules, module ctors and dtors, jumps, cases,
expressions, typechecking, name mangling and C-compatible interfacing
(extern "C"), (OpenMP?), and other to GENERIC (with the help of proper
hooks).  Show examples taken from \Algol 60 code.
