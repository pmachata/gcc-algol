...
\projectinfo{
  ...
  date=22nd May 2007,
  %Nazev prace
  title.cs={Me\-to\-do\-lo\-gi\-e kon\-struk\-ce pøed\-ní èá\-sti pøe\-kla\-da\-èe a~je\-jí in\-te\-gra\-ce do GNU Compiler Collection},
  title.en={\\Methodology of Construction Compiler Front-End and Its Integration into the GNU Compiler Collection},
  %Autor
  author=Petr Machata,
  author.title.p=Bc.,
  author.title.a=,
...
goes completely away, so there is neither a performance cont, nor a
memory overhead.
